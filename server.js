...
// YouTube URL එකෙන් වීඩියෝ ID එක වෙන් කරගන්නා ශ්‍රිතය
...
// =========================================================================
// 🎨 1. HTML FRONTEND (𝐐𝐔𝐄𝐄𝐍 𝐍𝐄𝐋𝐔𝐌𝐈 නිල වෙබ් පිටුව)
// =========================================================================
app.get('/', (req, res) => {
    res.send(`
        <!DOCTYPE html>
        ...
        <head>
            ...
            <title>𝐐𝐔𝐄𝐄𝐍 𝐍𝐄𝐋𝐔𝐌𝐈 𝐌🇩 - YouTube MP3 Downloader</title>
            <style>
                ...
                h1 { color: #ff007f; margin-bottom: 5px; font-size: 28px; font-weight: bold; letter-spacing: 1px; }
                .subtitle { color: #00ffcc; font-size: 14px; font-weight: 600; margin-bottom: 25px; text-transform: uppercase; letter-spacing: 2px; }
                ...
                .loading { display: none; color: #00ffcc; margin-top: 20px; font-weight: bold; font-family: monospace; }
                ...
                .footer { margin-top: 25px; font-size: 11px; color: #555; font-family: monospace; }
            </style>
        </head>
        <body>

        <div class="container">
            <h1>𝐐𝐔𝐄𝐄𝐍 𝐍𝐄𝐋𝐔𝐌𝐈 𝐌🇩</h1>
            <div class="subtitle">✨ YouTube MP3 Downloader ✨</div>
            
            <input type="text" id="userInput" placeholder="https://youtu.be/... හෝ සින්දුවේ නම ගහන්න">
            <button onclick="startDownload()">Convert to MP3</button>

            <div class="loading" id="loader">⏳ QUEEN NELUMI IS CONVERTING... PLEASE WAIT...</div>
            ...
            <div class="footer">⚡ Powered by Mr Thinuzz API Engine</div>
        </div>
...
// =========================================================================
// ⚡ 2. SCRAPER ENGINE (Mr Thinuzz Format API)
// =========================================================================
app.get('/api/ytmp3', async (req, res) => {
    try {
        ...
        // 📝 උඹ ඉල්ලපු නිවැරදිම JSON Structure එක
